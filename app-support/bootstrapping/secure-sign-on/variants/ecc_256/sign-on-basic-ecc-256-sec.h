...
/**@brief The bootstrapping request signature should be an ecdsa sha256 signature, so this function
 *          will return the size of an ecdsa sha256 signature in the format used by the micro-ecc
 *          library.
 *          
 */
...
/**@brief The certificate request signature should be an ecdsa sha256 signature, so this function
 *          will return the size of an ecdsa sha256 signature in the format used by the micro-ecc
 *          library.
 *          
 */
...
/**@brief The finish message signature should be an ecdsa sha256 signature, so this function
 *          will return the size of an ecdsa sha256 signature in the format used by the micro-ecc
 *          library.
 *          
 */
