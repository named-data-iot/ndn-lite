 ...
 * The format of the signature generated will be of the same format as the micro-ecc library.
...
/**
 * Verify an ECDSA signature in the format generated by the micro-ecc library.
