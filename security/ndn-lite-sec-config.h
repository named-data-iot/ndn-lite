...
#define NDN_LITE_SEC_BACKEND_SIGN_VERIFY_DEFAULT
...
// current options:
//   NDN_LITE_SEC_BACKEND_CRYPTO_KEY_DEFAULT
//   NDN_LITE_SEC_BACKEND_CRYPTO_KEY_NRF_CRYPTO
#define NDN_LITE_SEC_BACKEND_CRYPTO_KEY_DEFAULT
