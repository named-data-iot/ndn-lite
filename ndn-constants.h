...
#define NDN_APPSUPPORT_KEYID_SIZE 30
#define NDN_APPSUPPORT_TSK_ENTRY_MAX_SIZE 10
#define NDN_APPSUPPORT_TSK_SIZE 16
#define NDN_APPSUPPORT_SALT_SIZE 16
#define NDN_APPSUPPORT_INVALID_TSK_SIZE ((uint32_t)(-1))
#define NDN_APPSUPPORT_INVALID_KEYID_SIZE ((uint32_t)(-1))
